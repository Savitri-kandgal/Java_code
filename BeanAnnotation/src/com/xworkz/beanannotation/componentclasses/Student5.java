...
public class Student5 {
	...
	public Student5(@Value("5") int id, @Value("Mamata") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("F") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Mamata@gmail.com") String email,
	...
	public String toString() {
		return "Student5 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
