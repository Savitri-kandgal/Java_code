...
public class Student11 {
	...
	public Student11(@Value("11") int id, @Value("Janani") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("F") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Janani@gmail.com") String email,
	...
	public String toString() {
		return "Student11 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
