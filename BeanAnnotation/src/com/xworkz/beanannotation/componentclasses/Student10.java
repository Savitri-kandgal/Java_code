...
public class Student10 {
	...
	public Student10(@Value("10") int id, @Value("Danu") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("M") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Danu@gmail.com") String email,
	...
	public String toString() {
		return "Student10 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
