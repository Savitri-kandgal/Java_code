...
public class Student4 {
	...
	public Student4(@Value("4") int id, @Value("Amrutha") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("F") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Amrutha@gmail.com") String email,
	...
	public String toString() {
		return "Student4 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
