...
public class Student8 {
	...
	public Student8(@Value("8") int id, @Value("Yashshwini") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("F") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Yashshwini@gmail.com") String email,
	...
	public String toString() {
		return "Student8 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
