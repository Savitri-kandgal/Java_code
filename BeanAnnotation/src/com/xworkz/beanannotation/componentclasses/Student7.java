...
public class Student7 {
	...
	public Student7(@Value("7") int id, @Value("Lalita") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("F") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Lalita@gmail.com") String email,
	...
	public String toString() {
		return "Student7 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
