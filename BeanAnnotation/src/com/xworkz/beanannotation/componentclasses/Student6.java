...
public class Student6 {
	...
	public Student6(@Value("6") int id, @Value("Kaveri") String name, @Value("5.5f") float height,
			@Value("50.5") double weight, @Value("F") char gender, @Value("8756432987")long phNo, @Value("B.TECH") String qualification,
			@Value("Indra nagar") String address, @Value("Kaveri@gmail.com") String email,
	...
	public String toString() {
		return "Student6 [id=" + id + ", name=" + name + ", height=" + height + ", weight=" + weight + ", gender="
