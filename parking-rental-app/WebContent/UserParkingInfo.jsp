...
<script>
	function vehicleNoAjax() {
		...
		var url = "http://localhost:8080/parking-rental-app/validateVehicleNo/"
				+ vehicleNo;
		//	console.log(url);
...
<script>
	function ajaxWithObj() {
		...
		var url = "http://localhost:8080/parking-rental-app/getPriceAndDiscount/"
				+ location
				+ "/"
				+ vehicleType
				+ "/"
...
<div class="wrapper rounded bg-white" style="margin-top:;">
			...
			<span style="color: red;" id="display">${error}</span>
				...
				<div class="card shadow">
					...
					<div class="card-body">
						<form action="addUserParkingInfo" method="post">
