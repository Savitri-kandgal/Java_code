...
<input class="btn w-40" style="background-color: turquoise; margin-right: 80px; font-weight: bold;" type="submit" value="Search"/>
	...
	<script
		...
		crossorigin="anonymous"></script>
	<div class="footer">
		<small style="color:white;">&copy; Created by: Savitri B Kandgal,</small><small style="color:white;">&ensp;Savitri.Kandgal@gmail.com</small><small style="color:green;"> | Last login time: ${sessionDTO.loginTime}</small>
	</div>
</body>
</html>